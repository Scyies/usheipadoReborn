...
function TextInputRoot({ children }: TextInputRootProps) {
  return (
    <div className='relative flex items-center gap-3 py-4 px-3 h-12 rounded bg-gray-700 w-full focus-within:ring-2 ring-orange-500'>
      {children}
    </div>
  );
}
...
function TextInputInput({ ...rest }: TextInputInputProps) {
  return (
    <input
      className='bg-transparent min-w-[10px] flex-1 text-white-200 text-xs outline-none placeholder:text-gray-300'
      {...rest}
    />
  );
}
